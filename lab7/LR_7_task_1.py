...
class AntColony(object):
    ...
    # Оновлення рівнів феромонів, основуючись на
    # найкоротшому знайденому шляху
    ...
    # Рахуємо загальну відстань шляху
    ...
    # Генеруємо шляхи для всіх мурах
    ...
    # Обираємо наступний рух, основуючись на
    # рівнях феромонів та відстані
...
if __name__ == '__main__':
    # Місто, з якого починаємо шлях
    start_city_index = cities.index('Дніпро')

    # Створюємо інстанс класу AntColony
    ant_colony = AntColony(distances, 20, 5, 100, 0.8, alpha=0.9, beta=0.4)

    # Запускаємо алгоритм оптимізації та виводимо результат
    result = ant_colony.run(start=start_city_index)
